    ...
    <div class="container">
        <div class="row">
            ...
            <main class="col-md-8 ms-sm-auto col-lg-9 px-md-4">
                <div id="content-area">
                    <h3 class="sveden_title">Организация питания в образовательной организации</h3>
                    <h5 class="title_doc mt-4">Организация питания студентов</h5>
                    <!-- Проверка наличия документов -->
                    @if($foodEduDocuments ->isEmpty())
                        <p>Документов нет.</p>
                    @else
                        <ul class="list-group list-doc">
                            @foreach($foodEduDocuments  as $document)
